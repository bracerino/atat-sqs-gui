...
import io
import re
from more_funct.atat_module import *
...
def render_sqs_module():
        ...
        if how_cite:
            with st.expander("How to cite", icon="📚", expanded=True):
                st.markdown("""
                 ...
                 - **SimplySQS interface** - [M. Lebeda, et al. SimplySQS: An Automated and reproducible workflow for special quasirandom structure generation with ATAT. Journal of Computational Science, 2026](https://doi.org/10.1016/j.jocs.2026.102846).
                 - **ATAT mcsqs method** - [A. van de Walle, et al. Efficient stochastic generation of special quasirandom structures. Calphad, 2013](https://www.sciencedirect.com/science/article/pii/S0364591613000540?casa_token=i1iog7eW3lQAAAAA:wxlTn-9Twj38XFx1lMfSazPb6r0JrDV7NPxeums5-2qFXHWItT2ZVu9E-IfuBjRsr7f1BEzcSw).
                 - **ATAT** - [A. van de Walle, et al. The alloy theoretic automated toolkit: A user guide. Calphad, 2002](https://www.sciencedirect.com/science/article/abs/pii/S0364591602800062).
            """)
    with cl2:
                            ...
                            with st.spinner(f"Searching **the MC3D database** (limit: {mc3d_limit}), please wait. 😊"):
                                ...
                                try:
                                    ...
                                    if search_mode == "Elements":
                                        ...
                                        if not mc3d_ids:
                                            st.warning(
                                                "No valid MC3D IDs found (should start with 'mc3d-' or 'mcloud-')")
                                        else:
    ...
    if 'full_structures' in st.session_state and st.session_state['full_structures']:
        ...
        st.info("""
            ...
            See also our corresponding **[publication](https://doi.org/10.1016/j.jocs.2026.102846)** for **SimplySQS**.
        """)
        intro_text()
