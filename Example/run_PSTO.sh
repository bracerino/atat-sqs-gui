...
# Concentration sweep script for Pb-Sr system
# Generated by SimplySQS
# Corrdump command: corrdump -l=rndstr.in -ro -noe -nop -clus -2=1.5 -3=1.2
# Total sites in supercell: 64
# Parallel runs per concentration: 5
# Maximum concurrent jobs: 5
# Concentrations: [0.015625, 0.0625, 0.109375, 0.15625, 0.203125, 0.25, 0.296875, 0.34375, 0.390625, 0.4375, 0.484375, 0.53125, 0.578125, 0.625, 0.671875, 0.71875, 0.765625, 0.8125, 0.859375, 0.90625, 0.953125]
# Total estimated time: 5040.0 minutes

set -e

SWEEP_ELEMENT="Pb"
COMPLEMENT_ELEMENT="Sr"
TIME_PER_CONC_DEFAULT=240.0
MAX_PARALLEL=5
PARALLEL_RUNS_PER_CONC_DEFAULT=5
CORRDUMP_CMD="corrdump -l=rndstr.in -ro -noe -nop -clus -2=1.5 -3=1.2"
...
echo "🔍 Concentrations to be searched: [0.015625, 0.0625, 0.109375, 0.15625, 0.203125, 0.25, 0.296875, 0.34375, 0.390625, 0.4375, 0.484375, 0.53125, 0.578125, 0.625, 0.671875, 0.71875, 0.765625, 0.8125, 0.859375, 0.90625, 0.953125]"
...
try:
    ...
    comment = "SQS PbSr conc=$conc from $bestsqs_file"
...
run_concentration() {
    ...
    cat > rndstr.in << EOF
0.966964 0.966964 1.000000 90.00 90.00 90.00
1 0 0
0 1 0
0 0 1
0.500000 0.500000 0.528400 Ti
0.000000 0.000000 0.000000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.000000 0.500000 0.582000 O
0.500000 0.000000 0.582000 O
0.500000 0.500000 0.084000 O
EOF
