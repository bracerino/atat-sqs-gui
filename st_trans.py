        ...
        if how_cite:
            with st.expander("How to cite", icon="📚", expanded=True):
                st.markdown("""
                 ...
                 - **SimplySQS interface (PREPRINT, arXiv)** - [LEBEDA, Miroslav, et al. Simplifying Generation of Special Quasirandom Structures with ATAT Using Interactive Online Interface-SimplySQS. arXiv preprint arXiv:2510.18020, 2025](https://arxiv.org/abs/2510.18020).
