        ...
        if how_cite:
            with st.expander("How to cite", icon="📚", expanded=True):
                st.markdown("""
                 ...
                 - **SimplySQS interface (PREPRINT, arXiv)** - [LEBEDA, Miroslav, et al. SimplySQS: An Automated and Reproducible Workflow for Special Quasirandom Structure Generation with ATAT. arXiv preprint arXiv:2510.18020, 2025](https://arxiv.org/abs/2510.18020).
